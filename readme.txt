...
Xilitheme select provides an automatic selection of theme one for current browers and another for iphone/ipod touch brower. 

== Description ==
** first public release - preliminary doc - updated 081017 - see also code **
Xilitheme select provides an automatic selection of theme one for current browers and another for iphone/ipod touch browser.
